...
def examples_page():
    ...
    st.markdown('You will be shown pairs of images and descriptions generated by an AI model. Your task is to generate a "reformulation" of the description by writing a similar description in which the errors from the original description (if such exists), are fixed. If the model generated description is too bad to fix, write a new description.')
    ...
    st.markdown('**Model generated description:** An elephant eating from a tree top')
    ...
    st.markdown('**Model generated description:** A boy playing a card game')
    ...
    st.markdown('**Model generated description:** A tennis player hitting the ball with a racket **[Description too bad to fix]**')
...
def annotation_page():
    ...
    if len(state.unvisited_samples) > 0:
        ...
        st.markdown('**Model generated description:** ' + sample['caption'])
        st.markdown('**Reformulation:**')
